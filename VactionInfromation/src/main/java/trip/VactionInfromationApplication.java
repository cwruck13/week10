...
public class VactionInfromationApplication {
	...
	public void run(String... args) throws Exception {
		...
		Contact con = new Contact("Mary Jo","222-222-2222", "yes");
		Destination de = new Destination("USA", "Florida", "Jacksonville");
		con.setDestination(de);
		repo.save(con);
